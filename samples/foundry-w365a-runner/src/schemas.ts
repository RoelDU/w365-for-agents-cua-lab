 ...
 * monorepo root) plus compiled Ajv validators. Embedded here - rather than read
 * from ..\..\schemas at runtime - so the runner is portable as a standalone
 * release artifact. Version-pinned to the `v1` $id segment; if the canonical
 * schemas change, update these copies to match.
 */
